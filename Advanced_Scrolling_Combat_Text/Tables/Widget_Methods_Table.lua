local function defaultFunc(L_ASCT_Widget_Methods, key)
...
ASCT_Widget_Methods_Table = setmetatable({}, {__index=defaultFunc});
--local L_ASCT_Widget_Methods = ASCT_Widget_Methods_Table