...
ASCT.Widget.API["SetPoint"](ASCT.Frames.Initializers["ASCT_Config"], ASCT.Strings.Point["CENTER"], UIParent, ASCT.Strings.Point["CENTER"], -950, 200)
...
ASCT.Widget.API["SetSize"](ASCT.Frames.Initializers["ASCT_Config"], 950, 650)
