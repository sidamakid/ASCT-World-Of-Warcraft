...
Scripts.Frame["OnEvent"](f, --Run when our event fires
    function(self, event, unit, _, spellName)
      ...
      --Spells
         ...
         DB["Brewmaster"][Spell_Localize] or DB["Mistweaver"][Spell_Localize] or DB["Windwalker"][Spell_Localize]
      --Racials
      ...
      --Racials
         ...
         --Pandaren
         db_Pandaren and (db_Pandaren.SpellEnable == true)
      then
