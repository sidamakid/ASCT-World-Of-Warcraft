...
if L_Version_Check_Keys["isTbcWowOrAbove"] then
...
---------------------------
local f = L_ASCT_Frames["SARTE-Text-Shared-Spell-Cooldowns_Frame"]
...
L_ASCT_Handlers["OnEvent"](f, --Run when our event fires
   function(self, event, unit, _, spellName)
      ...
      if unit == "player" then
       if SpellTableShamanLust[L_ASCT_Locale_Spells["ASCT_GetEnglishName"](spellName)] and ASCT_DB["Shared_Shaman_spells"]["Lust"] == true then
