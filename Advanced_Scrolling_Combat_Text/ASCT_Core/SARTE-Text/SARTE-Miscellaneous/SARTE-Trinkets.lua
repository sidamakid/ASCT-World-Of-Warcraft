local ASCT, L, L_ASCT_Frames, L_ASCT_Handlers, L_Function_Keys = ASCT_Table, ASDC_LOCALE_TABLE, ASCT_Frames_Table, ASCT_Script_Handlers_Table, Functions_For_ASDC_Table
