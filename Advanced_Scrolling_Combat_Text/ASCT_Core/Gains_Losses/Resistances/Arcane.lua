...
local lastStat = -1
local f = ASCT.Frames.SARTE["Arcane_Resistance_Frame"]
...
ASCT.Scripts.Frame["OnEvent"](f, function()
    ...
    local base, total, bonus, minus = ASCT.API.Documentation["UnitResistance"]("player", ASCT.Str_Int.Resistance["Arcane"])
