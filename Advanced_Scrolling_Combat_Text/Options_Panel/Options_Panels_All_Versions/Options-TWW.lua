...
for i = 1, numTabs do
  ...
  if (i == 1) then
    ...
    Widget.API["SetPoint"](tab, Strings.Point["TOPLEFT"], Lua_API.Var_Environment["_G"][frameName.."Tab"..(i - 1)], Strings.Point["TOPRIGHT"], 10, 0);
  end
end
...
for v in PairsByKeys(ASCT_DB, ASCT_DB["Advanced_Scrolling_Combat_Text_Leveling"]) do
	...
	Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_TWW"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_TWW"]) * (Integers.SpellToggle.Row["x_AD_1"] % Integers.SpellToggle.Column["col_AD_1"]), Integers.SpellToggle.Y["Point_TWW"] + (- Widget.API["GetHeight"](b)-5) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_AD_1"]/Integers.SpellToggle.Column["col_AD_1"]))
...
for v in PairsByKeys(ASCT_DB, ASCT_DB["Display_On_Login"]) do
	...
	Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_TWW"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_TWW"]) * (Integers.SpellToggle.Row["x_AD_2"] % Integers.SpellToggle.Column["col_AD_2"]), Integers.SpellToggle.Y["Point_TWW"] + (- Widget.API["GetHeight"](b)-5) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_AD_2"]/Integers.SpellToggle.Column["col_AD_2"]))
	Widget.API["SetText"](b.Text, L[v])
...
for Stat, settings in PairsByKeys(ASCT_DB, ASCT_DB["Advanced_Scrolling_Combat_Text_Stats"]) do
    ...
    Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_TWW"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_TWW"]) * (Integers.SpellToggle.Row["x_AD_3"] % Integers.SpellToggle.Column["col_AD_3"]), Integers.SpellToggle.Y["Point_TWW"] + (- Widget.API["GetHeight"](b)-70) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_AD_3"]/Integers.SpellToggle.Column["col_AD_3"]))
...
for Stat, settings in PairsByKeys(ASCT_DB, ASCT_DB["Trinkets"]) do
    ...
    Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_TWW"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_TWW"]) * (Integers.SpellToggle.Row["x_AD_4"] % Integers.SpellToggle.Column["col_AD_4"]), Integers.SpellToggle.Y["Point_TWW"] + (- Widget.API["GetHeight"](b)-70) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_AD_4"]/Integers.SpellToggle.Column["col_AD_4"]))
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Assassination"]) do
    ...
    Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_TWW"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_TWW"]) * (Integers.SpellToggle.Row["x_1"] % Integers.SpellToggle.Column["col_1"]), Integers.SpellToggle.Y["Point_TWW"] + (- Widget.API["GetHeight"](b)-70) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_1"]/Integers.SpellToggle.Column["col_1"]))
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Outlaw"]) do
    ...
    Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_TWW"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_TWW"]) * (Integers.SpellToggle.Row["x_2"] % Integers.SpellToggle.Column["col_2"]), Integers.SpellToggle.Y["Point_TWW"] + (- Widget.API["GetHeight"](b)-70) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_2"]/Integers.SpellToggle.Column["col_2"]))
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Subtlety"]) do
    ...
    Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_TWW"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_TWW"]) * (Integers.SpellToggle.Row["x_3"] % Integers.SpellToggle.Column["col_3"]), Integers.SpellToggle.Y["Point_TWW"] + (- Widget.API["GetHeight"](b)-70) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_3"]/Integers.SpellToggle.Column["col_3"]))
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Undead"]) do
    ...
    Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_TWW"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_TWW"]) * (Integers.SpellToggle.Row["x_4"] % Integers.SpellToggle.Column["col_4"]), Integers.SpellToggle.Y["Point_TWW"] + (- Widget.API["GetHeight"](b)-70) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_4"]/Integers.SpellToggle.Column["col_4"]))
...
local stringTable = {
    "/ccb settings: Displays settings for ASCT chatbox",
    "/ccb hide: Hide ASCT chatbox",
    "/ccb show: Display ASCT chatbox",
    "/ccb reset: Reset ASCT chatbox postion and size",
    "/ccb resetposition: Reset only the postion of ASCT chatbox",
    "/ccb: resetsize: Reset only size of ASCT chatbox",
}
