...
--Create SavedVars
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local defaults = Functions.Table["TableCombine"](Database.Spells["Spells_Wrath"], Database.Spells["Others_Wrath"])
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
local Icon_Slider = Frames.Widgets["CreateSlider"]("Icon_slider", content11, 200, 20, Strings.Point["TOPLEFT"], 20, -20, Strings.Orientation["HORIZONTAL"], 1, 50, "Integer_Values", "Icon", 1, L["The size of the message icon"], '1', '50', Icon_Slider_Text)
---------------------------
--Debuff Slider
---------------------------
...
local Debuff_Slider = Frames.Widgets["CreateSlider"]("Debuff_Slider_S", content11, 200, 20, Strings.Point["TOPLEFT"], 20, -140, Strings.Orientation["HORIZONTAL"], 1, 20, "Integer_Values", "Debuff_time", 1, L["The time warning for Debuffs about to fade"], "1", "20", Debuff_Slider_Text)
---------------------------
