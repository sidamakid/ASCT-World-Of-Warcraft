...
local defaults = ASCT.Functions["TableCombine"](ASCT.Database.Spells["Spells_Cataclysm"], ASCT.Database.Spells["Others_Cataclysm"])
...
local Spell_Name = ASCT.Locale.Spells["ASCT_GetLocalizedName"]
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Assassination"]) do
    local b = CreateSpellToggle(Spell_Name, Locale_SpellIcon, spellName, settings, content1)
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Combat"]) do
    local b = CreateSpellToggle(Spell_Name, Locale_SpellIcon, spellName, settings, content2)
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Subtlety"]) do
    local b = CreateSpellToggle(Spell_Name, Locale_SpellIcon, spellName, settings, content3)
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Undead"]) do
    local b = CreateSpellToggle(Spell_Name, Locale_SpellIcon, spellName, settings, content4)
    ASCT.Widget.API["SetPoint"](b, ASCT.Strings.Point["TOPLEFT"], 20 + (ASCT.Widget.API["GetWidth"](b)+200) * (x_1 % col_1), -20 + (- ASCT.Widget.API["GetHeight"](b)-70) * math.floor(x_1/col_1))
    x_1=x_1+1
