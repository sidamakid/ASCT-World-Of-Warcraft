...
local defaults = ASCT.Functions["TableCombine"](ASCT.Database.Spells["Spells_DF"], ASCT.Database.Spells["Others_DF"])
...
for i = 1, numTabs do
  local tab = ASCT.API.Documentation["CreateFrame"]("Button", frameName.."Tab"..i, frame, "PanelTabButtonTemplate");
  ...
  if (i == 1) then
    ASCT.Widget.API["SetPoint"](tab, ASCT.Strings.Point["TOPLEFT"], ASCT_Config, ASCT.Strings.Point["BOTTOMLEFT"], 10, 7);
  else
    ASCT.Widget.API["SetPoint"](tab, ASCT.Strings.Point["TOPLEFT"], _G[frameName.."Tab"..(i - 1)], ASCT.Strings.Point["TOPRIGHT"], 10, 0);
  end
end
...
local TextTop = TitleCreate(content6, ASCT.Strings.Point["TOP"], 0, -10, ASCT.Strings.Point["TOP"], L["This Tab is for Shaman's and Hunter's only."])
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Assassination"]) do
    ...
    ASCT.Widget.API["SetPoint"](b, ASCT.Strings.Point["TOPLEFT"], 60 + (ASCT.Widget.API["GetWidth"](b)+200) * (x_1 % col_1), -20 + (- ASCT.Widget.API["GetHeight"](b)-70) * math.floor(x_1/col_1))
    x_1=x_1+1
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Outlaw"]) do
    ...
    ASCT.Widget.API["SetPoint"](b, ASCT.Strings.Point["TOPLEFT"], 60 + (ASCT.Widget.API["GetWidth"](b)+200) * (x_2 % col_2), -20 + (- ASCT.Widget.API["GetHeight"](b)-70) * math.floor(x_2/col_2))
    x_2=x_2+1
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Subtlety"]) do
    ...
    ASCT.Widget.API["SetPoint"](b, ASCT.Strings.Point["TOPLEFT"], 60 + (ASCT.Widget.API["GetWidth"](b)+200) * (x_3 % col_3), -20 + (- ASCT.Widget.API["GetHeight"](b)-70) * math.floor(x_3/col_3))
    x_3=x_3+1
