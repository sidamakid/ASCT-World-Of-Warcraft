...
local defaults = L_Table_Functions["TableCombine"](L_Database_Keys["Spells_DF"], L_Database_Keys["Others_DF"])
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Assassination"]) do
    ...
    L_ASCT_Widget_Methods["SetPoint_3"](b, "TOPLEFT", 60 + (b:GetWidth()+200) * (x_1 % col_1), -20 + (- b:GetHeight()-70) * math.floor(x_1/col_1))
    x_1=x_1+1
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Outlaw"]) do
    ...
    L_ASCT_Widget_Methods["SetPoint_3"](b, "TOPLEFT", 60 + (b:GetWidth()+200) * (x_2 % col_2), -20 + (- b:GetHeight()-70) * math.floor(x_2/col_2))
    x_2=x_2+1
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Subtlety"]) do
    ...
    L_ASCT_Widget_Methods["SetPoint_3"](b, "TOPLEFT", 60 + (b:GetWidth()+200) * (x_3 % col_3), -20 + (- b:GetHeight()-70) * math.floor(x_3/col_3))
    x_3=x_3+1
...
for v in PairsByKeys(ASCT_DB, ASCT_DB["Shared_Shaman_spells"]) do
	...
	L_ASCT_Widget_Methods["SetPoint_3"](b, "TOPLEFT", 60 + (b:GetWidth()+200) * (x_4 % col_4), -20 + (- b:GetHeight()-25) * math.floor(x_4/col_4))
	b.Text:SetText(L[v])
