...
--Create SavedVars
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local defaults = Functions.Table["TableCombine"](Database.Spells["Spells_MOP"], Database.Spells["Others_MOP"])
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
for v in PairsByKeys(ASCT_DB, ASCT_DB["Advanced_Scrolling_Combat_Text_Leveling"]) do
	...
	Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_MOP"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_MOP"]) * (Integers.SpellToggle.Row["x_AD_1"] % Integers.SpellToggle.Column["col_AD_1"]), Integers.SpellToggle.Y["Point_MOP"] + (- Widget.API["GetHeight"](b)-5) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_AD_1"]/Integers.SpellToggle.Column["col_AD_1"]))
...
for v in PairsByKeys(ASCT_DB, ASCT_DB["Display_On_Login"]) do
	...
	Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_MOP"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_MOP"]) * (Integers.SpellToggle.Row["x_AD_2"] % Integers.SpellToggle.Column["col_AD_2"]), Integers.SpellToggle.Y["Point_MOP"] + (- Widget.API["GetHeight"](b)-5) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_AD_2"]/Integers.SpellToggle.Column["col_AD_2"]))
	Widget.API["SetText"](b.Text, L[v])
...
for Stat, settings in PairsByKeys(ASCT_DB, ASCT_DB["Advanced_Scrolling_Combat_Text_Stats"]) do
    ...
    Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_MOP"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_MOP"]) * (Integers.SpellToggle.Row["x_AD_3"] % Integers.SpellToggle.Column["col_AD_3"]), Integers.SpellToggle.Y["Point_MOP"] + (- Widget.API["GetHeight"](b)-70) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_AD_3"]/Integers.SpellToggle.Column["col_AD_3"]))
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Assassination"]) do
    ...
    Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_MOP"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_MOP"]) * (Integers.SpellToggle.Row["x_1"] % Integers.SpellToggle.Column["col_1"]), Integers.SpellToggle.Y["Point_MOP"] + (- Widget.API["GetHeight"](b)-70) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_1"]/Integers.SpellToggle.Column["col_1"]))
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Combat"]) do
    ...
    Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_MOP"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_MOP"]) * (Integers.SpellToggle.Row["x_2"] % Integers.SpellToggle.Column["col_2"]), Integers.SpellToggle.Y["Point_MOP"] + (- Widget.API["GetHeight"](b)-70) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_2"]/Integers.SpellToggle.Column["col_2"]))
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Subtlety"]) do
    ...
    Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_MOP"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_MOP"]) * (Integers.SpellToggle.Row["x_3"] % Integers.SpellToggle.Column["col_3"]), Integers.SpellToggle.Y["Point_MOP"] + (- Widget.API["GetHeight"](b)-70) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_3"]/Integers.SpellToggle.Column["col_3"]))
...
for v in PairsByKeys(ASCT_DB, ASCT_DB["Shared_Shaman_spells"]) do
	...
	Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_MOP"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_MOP"]) * (Integers.SpellToggle.Row["x_Shared"] % Integers.SpellToggle.Column["col_Shared"]), -20 + (- Widget.API["GetHeight"](b)-25) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_Shared"]/Integers.SpellToggle.Column["col_Shared"]))
	Widget.API["SetText"](b.Text, L[v])
...
for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Undead"]) do
    ...
    Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_MOP"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_MOP"]) * (Integers.SpellToggle.Row["x_4"] % Integers.SpellToggle.Column["col_4"]), Integers.SpellToggle.Y["Point_MOP"] + (- Widget.API["GetHeight"](b)-70) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_4"]/Integers.SpellToggle.Column["col_4"]))
...
--Panderen
---------------------
elseif ASCT_DB["Race"]["Panderen"] == true then
    for spellName, settings in PairsByKeys(ASCT_DB, ASCT_DB["Panderen"]) do
        local b = CreateSpellToggle(Locale_SpellName, Locale_SpellIcon, spellName, settings, content4)
        Widget.API["SetPoint"](b, Strings.Point["TOPLEFT"], Integers.SpellToggle.X["Point_MOP"] + (Widget.API["GetWidth"](b)+Integers.SpellToggle.Width["Width_MOP"]) * (Integers.SpellToggle.Row["x_4"] % Integers.SpellToggle.Column["col_4"]), Integers.SpellToggle.Y["Point_MOP"] + (- Widget.API["GetHeight"](b)-70) * Lua_API.Math["math.floor"](Integers.SpellToggle.Row["x_4"]/Integers.SpellToggle.Column["col_4"]))
        Integers.SpellToggle.Row["x_4"]=Integers.SpellToggle.Row["x_4"]+1
        CreateNameIconToggles(b, settings, content4)
