...
local defaults = L_Table_Functions["TableCombine"](L_Database_Keys["Spells_Cataclysm"], L_Database_Keys["Others_Cataclysm"])
...
for i = 1, numTabs do
  ...
  if (i == 1) then
    L_ASCT_Widget_Methods["SetPoint"](tab, "TOPLEFT", ASCT_Config, "BOTTOMLEFT", 5, 7);
  else
...
for v in PairsByKeys(ASCT_DB, ASCT_DB["Advanced_Scrolling_Combat_Text_Leveling"]) do
	...
	L_ASCT_Handlers["OnClick"](b, function(s) ASCT_DB["Advanced_Scrolling_Combat_Text_Leveling"][v] = s:GetChecked() end)
	x_AD=x_AD+1
end
---------------------------
...
for v in PairsByKeys(ASCT_DB, ASCT_DB["Shared_Shaman_spells"]) do
	...
	L_ASCT_Handlers["OnClick"](b, function(s) ASCT_DB["Shared_Shaman_spells"][v] = s:GetChecked() end)
	x_4=x_4+1
end
---------------------------
--Warlock
...
for v in PairsByKeys(ASCT_DB, ASCT_DB["Shared_Hunter_spells"]) do
	...
	L_ASCT_Handlers["OnClick"](b, function(s) ASCT_DB["Shared_Hunter_spells"][v] = s:GetChecked() end)
	x_4=x_4+1
end
---------------------------
--Paladin
