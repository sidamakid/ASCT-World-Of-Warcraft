...
--Normal table
---------------------------
local defaults = L_Table_Functions["TableCombine"](L_Database_Keys["Spells_Vanilla"], L_Database_Keys["Others_Vanilla"])
---------------------------
...
L_ASCT_Widget_Methods["SetFontObject"](title, "GameFontHighlight")
L_ASCT_Widget_Methods["SetPoint_4"](title, "TOP", ASCT_Config, "TOP", 1, -7);
L_ASCT_Widget_Methods["SetText"](title, L["Title"]);
