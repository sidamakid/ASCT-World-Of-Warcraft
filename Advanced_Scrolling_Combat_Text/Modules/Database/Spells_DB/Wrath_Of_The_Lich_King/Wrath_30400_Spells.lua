...
if ASCT.Client.LE_EXPANSION_LEVEL["isWrathWow"] and ASCT.Client.tocversion["is30400"] then
...
ASCT.Functions.Table["TableCombine"](ASCT.Database.Spells["Spells_Wrath"]["Enhancement"], Lust_Table)
