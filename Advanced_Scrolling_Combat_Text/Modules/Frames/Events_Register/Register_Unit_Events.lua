...
--UNIT
---------------------------
L_ASCT_Events["UNIT_SPELLCAST_SUCCEEDED"] = function(Frame) L_ASCT_Locale_Spells["ASCT_AddLocalizedCallback"](function() Frame:RegisterEvent("UNIT_SPELLCAST_SUCCEEDED") end) return Frame end
