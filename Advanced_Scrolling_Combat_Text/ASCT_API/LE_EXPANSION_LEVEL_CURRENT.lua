...
ASCT.API.Documentation["LE_EXPANSION_LEVEL_CURRENT_Equal"] = function (Expansion)
    local Expansion_Level_Current = (ASCT.Strings.LE_EXPANSION_LEVEL["LE_EXPANSION_LEVEL_CURRENT"] == Expansion)
...
---------------------------
--Not Expanison or equal Le_Expansion_Level_Current Function
---------------------------
...
---------------------------
--Not Equal Expansion Le_Expansion_Level_Current Function
---------------------------
